...
const App: React.FC = () => {
  ...
  return (
      <div className="min-h-screen bg-gray-50">
        <Navbar />
        {/* Hero Section */}
        <div className="relative h-[500px] bg-gradient-to-r from-green-700 to-green-900">
              ...
              <div className="bg-white p-4 rounded-lg shadow-lg">
                <div className="flex flex-col md:flex-row gap-4">
                  ...
                  <div className="flex-1 flex gap-4">
                    ...
                    />
                    <button className="bg-green-600 text-white px-8 py-2 rounded-md hover:bg-green-800 transition-colors">
                      Search
                    </button>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <h2 className="text-3xl font-bold mb-8">Featured Hotels and Resorts</h2>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold">Safe Stays</h3>
                <p className="text-gray-600">All properties follow safety protocols</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Guaranteed best prices</p>
              </div>
            </div>
          </div>
        </div>
